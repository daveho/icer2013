...
\alignauthor
David Hovemeyer\\
       \affaddr{Kinsley Engineering Center}\\
...
We have built CloudCoder, an open platform for creating, assigning, and sharing
short programming exercises for a variety of languages (we currently
support C/C++, Java, Python and Ruby, and can add others).  Like other
systems, CloudCoder is a web service that lets
students write code directly in their web browser, click the
...
In this work, we report on successful pilot studies of CloudCoder at several
institutions.  We also describe on-going work to create a ``hint'' system
